						...
						<form:form action="search1" method="POST"
							...
							<div class="input-group">
								<input type="text" class="form-control bg-light "
									placeholder="Suggetion Id" required="required" name="sug_id"
									aria-label="Search" />
								...
								<div class="card">
									<div class="card-body1">
										...
										<div class="d-md-flex align-items-center">
											<div>
												<br>
												<h4>&nbsp &nbsp Suggestion Details</h4>
									...
									<div class="table-responsive">
										<table class="table v-middle">
											<thead>
												<tr class="bg-light">
													<th class="border-top-0">SUGGESTION ID</th>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<h4 class="m-b-0 font-16">${item.sug_id}</h4>
															</div>
														</td>
														<td>${item.name}</td>
														<td>${item.email}</td>
														<td>${item.message}</td>
														<td><form action="deltlList3" method="get">
																<input type="hidden" name="id" value="${item.sug_id}"
																	readonly />
												...
												<c:when test="${not empty employeeList}">
													...
													<c:forEach var="theEmployee" items="${employeeList}">
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	<h4 class="m-b-0 font-16">${theEmployee.sug_id}</h4>
																</div>
															</td>
															<td>${theEmployee.name}</td>
															<td>${theEmployee.email}</td>
															<td>${theEmployee.message}</td>
															<td><form action="deltlList3" method="get">
																	<input type="hidden" name="id" value="${item.sug_id}"
																		readonly />
																	<button class="btn btn-sm btn-danger" type="submit">Delete</button>
