	...
	<div id="wrapper">
		...
		<nav class="fixed-top align-top" id="sidebar-wrapper"
			...
			<div class="simplebar-content" style="padding: 0px;">
				...
				<span class="align-middle">Fly Buy Mart></span>
				</a>
			...
			<div id="content">
				...
				<div class="container-fluid p-0 px-lg-0 px-md-0">
					...
					<nav class="navbar navbar-expand navbar-light my-navbar">
						...
						<form:form action="search3" method="POST"
							class="d-none d-sm-inline-block form-inline navbar-search">
							<div class="input-group">
								<input type="text" class="form-control bg-light "
									placeholder="User Id" required="required" name="id"
									aria-label="Search" />
								...
								<div class="card">
									<div class="card-body1">
										...
										<div class="d-md-flex align-items-center">
											<div>
												<br>
												<h4>&nbsp &nbsp Customer Details</h4>
											...
											<tbody>
												<c:forEach var="item" items="${reqlist}" varStatus="srno">
													<tr>
														...
														<td>${item.username}</td>
														<td>${item.password}</td>
														<td><form action="deltlList2" method="get">
												...
												<c:when test="${not empty employeeList}">
													...
													<c:forEach var="theEmployee" items="${employeeList}">
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	<h4 class="m-b-0 font-16">${theEmployee.id}</h4>
																</div>
															</td>
															<td>${theEmployee.username}</td>
															<td>${theEmployee.password}</td>
															<td><form action="deltlList2" method="get">
																	<input type="hidden" name="id" value="${item.id}"
																		readonly />
																	<button class="btn btn-sm btn-danger" type="submit">Delete</button>
