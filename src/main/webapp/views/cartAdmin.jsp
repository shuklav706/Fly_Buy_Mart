			...
			<div id="content">
				...
				<div class="container-fluid p-0 px-lg-0 px-md-0">
					...
					<nav class="navbar navbar-expand navbar-light my-navbar">
						...
						<form:form action="search4" method="POST"
							class="d-none d-sm-inline-block form-inline navbar-search">
							<div class="input-group">
								<input type="text" class="form-control bg-light "
									placeholder="Cart Id" required="required" name="cart_id"
									aria-label="Search" />
										...
										<table class="table v-middle">
											<thead>
												<tr class="bg-light">
													...
													<th class="border-top-0">PRODUCT IDS</th>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<h4 class="m-b-0 font-16">${item.cart_id}</h4>
															</div>
														</td>
														<td>${item.quantity}</td>
														<td>${item.product_ids}</td>
														<td><form action="deltlList4" method="get">
												...
												<c:when test="${not empty employeeList}">
													...
													<c:forEach var="theEmployee" items="${employeeList}">
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	<h4 class="m-b-0 font-16">${theEmployee.cart_id}</h4>
																</div>
															</td>
															<td>${theEmployee.quantity}</td>
															<td>${theEmployee.product_ids}</td>
															<td><form action="deltlList4" method="get">
																	<input type="hidden" name="id" value="${item.cart_id}"
																		readonly />
																	<button class="btn btn-sm btn-danger" type="submit">Delete</button>
