				...
				<c:forEach begin="0" end="0" var="product" items="${products }">
					<div class="col-3 mr-1">
						<div class="card" style="width: 12rem; height: 20rem">
							<img
								src="${pageContext.request.contextPath }/views/images/refrigerator/${product.photo }"
								class="card-img-top" style="height: 8rem; width: 11rem">
							<div class="card-body">
								<h5 class="card-title">${product.name }</h5>
								<p class="card-text">Rs. ${product.price }</p> 
								<a
									href="${pageContext.request.contextPath }/cart/buy5/${product.id}"
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr1.jsp"
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr2.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr3.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr4.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr5.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr6.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr7.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr8.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr9.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr10.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr11.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyrr12.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
