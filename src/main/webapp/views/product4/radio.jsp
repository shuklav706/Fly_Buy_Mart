				...
				<c:forEach begin="0" end="0" var="product" items="${products }">
					<div class="col-3 mr-1">
						<div class="card" style="width: 12rem; height: 20rem">
							<img
								src="${pageContext.request.contextPath }/views/images/radio/${product.photo }"
								class="card-img-top" style="height: 8rem; width: 11rem">
							<div class="card-body">
								<h5 class="card-title">${product.name }</h5>
								<p class="card-text">Rs. ${product.price }</p> 
								<a
									href="${pageContext.request.contextPath }/cart/buy4/${product.id}"
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr1.jsp"
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr2.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr3.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr4.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr5.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr6.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr7.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr8.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr9.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr10.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>	
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr11.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
						...
						<div class="card" style="width: 12rem; height: 20rem">
							...
							<div class="card-body">
								...
								<a
									...
									class="btn btn-dark" style="width:55px">BUY</a>
								<a
									href="http://localhost:8080/views/buyProduct1/buyr12.jsp"
									class="btn btn-dark" style="width:90px">SHOW</a>
							</div>
						</div>
					</div>
