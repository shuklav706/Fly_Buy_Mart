						...
						<form:form action="search2" method="POST"
							...
							<div class="input-group">
								<input type="text" class="form-control bg-light "
									placeholder="Order Id" required="required" name="order_id"
									aria-label="Search" />
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<h4 class="m-b-0 font-16">${item.order_id}</h4>
															</div>
														</td>
														<td>${item.name}</td>
														<td>${item.city}</td>
														...
														<td>${item.email}</td>
														<td>
															<form action="deltlList1" method="get">
												...
												<c:when test="${not empty employeeList}">
													...
													<c:forEach var="theEmployee" items="${employeeList}">
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	<h4 class="m-b-0 font-16">${theEmployee.order_id}</h4>
																</div>
															</td>
															<td>${theEmployee.name}</td>
															<td>${theEmployee.city}</td>
															<td>${theEmployee.state}</td>
															<td>${theEmployee.address}</td>
															<td>${theEmployee.mobile}</td>
